...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0007_alter_brand_register_date_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='updated_date',
            field=django_jalali.db.models.jDateField(default=datetime.date(2024, 3, 25), verbose_name='تاریخ آخرین بروزرسانی'),
        ),
        migrations.AlterField(
